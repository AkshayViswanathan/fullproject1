            ...
            <div class="bg-white h-4/5 w-2/5 rounded-md "  >   
                   ...
                   <div class="h-96 flex justify-between flex-wrap p-10" >
                    ...
                    <div>
                        ...
                        <label for="Remember Password" class="text-gray-700	 "> Remember Password</label>
                    </div>
