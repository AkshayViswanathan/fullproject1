  ...
  <div class="">
   ...
   <div class="DashboardBody bg-gray-300 h-screen w-screen flex pt-[100px]  items-center flex-col ">
        ...
        <div class="flex">
            ...
            <p class="" id="useremail"> bobmaraly@gmail.com </p>
        </div>
